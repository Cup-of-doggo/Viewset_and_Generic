...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson = Lesson.objects.create(
            lesson_name="first_test_name", owner=self.user
        )
    ...
    def test_create_lesson(self):
        ...
        self.assertEqual(response.data["lesson_name"], "test_name")

    def test_update_lesson(self):
        data = {"lesson_name": "new_test_name", "link": "https://www.youtube.com/"}
    ...
    def test_list_lesson(self):
        ...
        self.assertEqual(
            response.data["results"][0]["lesson_name"], self.lesson.lesson_name
        )
    ...
    def test_retrieve_lesson(self):
        ...
        response = self.client.get(url)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["lesson_name"], "first_test_name")
...
class IsOwnerOrStaffTestCase(APITestCase):
    def setUp(self):
        ...
        self.lesson = Lesson.objects.create(
            lesson_name="Owner Lesson", owner=self.owner
        )
...
class DistributionTaskTestCase(TestCase):
    ...
    def test_distribution_send_email_success(self, mock_send_mail):
        ...
        Subscription.objects.create(
            user=self.user, course=self.course, is_subscribe=True
        )
