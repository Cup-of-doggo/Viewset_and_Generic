...
class Lesson(models.Model):
    lesson_name = models.CharField(
        max_length=255, verbose_name="Название урока", null=True
    )
    lesson_description = models.TextField(
        verbose_name="Описание урока", blank=True, null=True
    )
    lesson_image = models.ImageField(
        upload_to="картинки/", verbose_name="Превью урока", null=True, blank=True
    )
...
class Course(models.Model):
    ...
    course_image = models.ImageField(
        upload_to="картинки/", verbose_name="Превью курса", null=True, blank=True
    )
...
class Subscription(models.Model):
    ...
    course = models.ForeignKey(
        Course, on_delete=models.CASCADE, verbose_name="Курс", null=True
    )
    is_subscribe = models.BooleanField(
        verbose_name="Подписка", null=True, blank=True, default=False
    )
